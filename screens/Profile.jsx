...
const Item = ({ item, navigation }) => {
  ...
  return (
    <View
      // onPress={() =>
      //   item.can_choose_cashback && navigation.navigate("Statistics")
      // }
      style={styles.card__wrapper}
    >
        ...
        <View style={styles.card__cashbacks}>{
          item.cashbacks.map(({product_type, value}) => (
            <View style={styles.card__cashback_item}>
              <CashbackIcon />
              <Text style={styles.card__cashback_title}>{product_type}{' '}{value}%</Text>
            </View>
          ))
        }</View>
      )}
